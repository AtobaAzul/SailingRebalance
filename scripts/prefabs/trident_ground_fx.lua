local assets = {Asset("ANIM", "anim/cavein_debris_fx.zip")}
...
local function fn()
    ...
    inst:DoTaskInTime(0, function() inst.SoundEmitter:PlaySoundWithParams("dontstarve/creatures/together/antlion/sfx/ground_break", {size = 1}) end)
