...
if GetModConfigData("config_violentCannons") then
    ...
    --TUNING.BOAT.BOATCANNON.RANGE = TUNING.BOAT.BOATCANNON.RANGE * 1.5
    ...
    --TUNING.BOAT.BOATCANNON.AIM_ANGLE_WIDTH = 180 / GLOBAL.RADIANS
end

if GetModConfigData("config_betterBumpers") then
    TUNING.BOAT.BUMPERS.KELP.HEALTH = TUNING.BOAT.BUMPERS.KELP.HEALTH*1.5
